...
DotPlot(leaf_10X, features = leaf_10X_markers_top2$gene, 
        ) +
...
```{r}
write_excel_csv(UMAP1$data, file = "../../CRO_manuscript_figures/Source_Files/Fig4a_1.csv")
write_excel_csv(leaf_assignment_graph$data, file = "../../CRO_manuscript_figures/Source_Files/Fig4a_2.csv")
```
...
ggsave("../Results/R_output_Leaf_scRNAseq/MIA_at_cell_type_leaf.svg", height = 7, width = 2.8, bg = "white")
ggsave("../Results/R_output_Leaf_scRNAseq/MIA_at_cell_type_leaf.png", height = 7, width = 2.8, bg = "white")
```
